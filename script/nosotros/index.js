...
$(document).ready(function(){
  $("#metatitle").html('Lean Outlet™ - Especialistas en Cultura Lean');
  $("#metadescription").attr("content",'Nos integra un equipo de profesionales y consultores en manufactura esbelta con una experiencia inigualable en proyectos de transformación lean.');
  $("#metakeywords").attr("content",'Consultoría; Consultores; Lean Manufacturing; Manufactura Esbelta; Especialistas Lean; Lean Assessment; Manufacturing');
