...
$(document).ready(function(){
  $("#metatitle").html('Lean Outlet™ - Aviso de Privacidad');
  $("#metadescription").attr("content",'Consulta el aviso de privacidad de Lean Outlet. Nuestro compromiso es mantener confidencial y segura toda tu información.');
