...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        icons: {
            ...
            toggle: 'glyphicon-vcard glyphicon-table',
            columns: 'glyphicon-content-41'
        },
    ...
    BootstrapTable.LOCALES['en-US'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf(' %s of %s rows', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-default" type="button" name="toggle" title="%s" style="display:none">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s" style="display:none;" >',
        ...
        if (this.options.search) {
            ...
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search">',
                    sprintf('<div class="buscar">Buscar:  </div> <input class="form-control buscador" type="text" >',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('<br> <span class="page-list"> ');

        var pageNumber = [
            '<span class="btn-group dropup btn-limitador2">',
            '<button type="button" class=" btn-default btn-limitador btn-pag">',
            '<span class="page-size">',
            this.options.pageSize,
            '</span>',
            '</button>',
            '<button type="button" class=" btn-default dropdown-toggle btn-limitador btn-flecha" data-toggle="dropdown">',
            '<span class="caret"></span>',
            '</button>',
            '<ul class="dropdown-menu limitador2" role="menu">'],
        ...
        html.push('</div>',
            '<div class="pull-right pagination">',
                '<ul class="pagination">',
                    ...
                    '<li class="page-pre"><a href="javascript:void(0)">Previo</a></li>');
        ...
        html.push(
                    '<li class="page-next"><a href="javascript:void(0)">Siguiente</a></li>',
    ...
    BootstrapTable.prototype.updatePagination = function (event) {
        ...
        var j=0;
         ...
         var tabla=this.$el.context.id;
         tabla="#"+tabla;
         var id=a[0];
         var nombre=a[1];
         var ruta=window.location["href"];
         ruta =  ruta.split('/');
         var ruta2= ruta[ruta.length-1];

         switch(ruta2){
            case 'blogs': $(tabla).arr(ruta2,id,nombre);break;
            case 'categoriasblogs': $(tabla).arr(ruta2,id,nombre);break;
            case 'etiquetas': $(tabla).arr(ruta2,id,nombre);break;
            case 'preguntastest': $(tabla).arr(ruta2,id,nombre);break;
            case 'faqs': $(tabla).arr(ruta2,id,nombre);break;
            case 'asuntos': $(tabla).arr(ruta2,id,nombre);break;
            case 'imglaterales': $(tabla).arr(ruta2,id,nombre);break;
            case 'extras': $(tabla).arr(ruta2,id,nombre);break;
            case 'sedes': $(tabla).arr(ruta2,id,nombre);break;

            case 'categoriascursos': $(tabla).arr(ruta2,id,nombre,1);break;
            case 'redessociales': $(tabla).arr(ruta2,id,nombre,1);break;
            case 'cursos': $(tabla).arr(ruta2,id,nombre,1);break;
            case 'publicidades': $(tabla).arr(ruta2,id,nombre,1);break;
            case 'especiales': $(tabla).arr(ruta2,id,nombre,1);break;
            case 'servicios': $(tabla).arr(ruta2,id,nombre,1);break;
            case 'usuarios': $(tabla).arr(ruta2,id,nombre,1);break;
         }
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    value = typeof value === 'undefined' || value === null ?
                        ...
                        //Aqui esa el cambio para la tabla

                        if (value[0]!=="<" & value.length > 20) {
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
		...
		/*var dataFilter = $(this.options.toolbar).bootstrapTableFilter("getData");
       	if(dataFilter.selector == undefined)
        ...
        $.ajax({
            ...
            dataType: this.options.dataType,
             beforeSend : function(xhr) {
                xhr.setRequestHeader("User-Agent", "ApiEnow");
    ...
    BootstrapTable.prototype.getCaretHtml = function () {
        ...
        if (this.options.sortOrder === 'desc') {
            var resu='<li id="MyElement" class="fa  fa-sort-amount-desc asc"></li>';
        }
        else var resu='<li id="MyElement" class="fa  fa-sort-amount-asc asc"></li>';
