...
function initinymce(){
    ...
    toolbar: "cut copy paste | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | undo redo | link unlink| image",
    menubar: false,
    ...
    setup : function(ed) {
      ...
      document_base_url: ".",
                file_picker_callback: function(callback, value, meta){
                    ...
                    var fin=rut.indexOf('admin')+5;
                    var ruta = rut.substr(0,fin);
                    win = tinymce.activeEditor.windowManager.open({
                        title: "Insertar Imagen",
                        url: ruta+"/index/media",
                        id: "ifUpload",
                        width: 500,
                        height:350,
                        buttons:[
                            {
                                ...
                                onclick: function(){
                                    var src = $("#ifUpload iframe").contents().find(".thumb li.selected img").attr("src");
                                    console.log(src);
                                    callback(src);
                                    win.close();
                                }
                            ...
                            {
                                text: "Subir Imagen",
                                casses: "widget btn success first abs-layout-item",
                                onclick: function(){
                                    $("#ifUpload iframe").contents().find("#ipUploader").click();
                                }
                            },
                            {
                                text: "Cancelar",
